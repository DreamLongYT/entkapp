...
export class VitePlugin extends BasePlugin {
  ...
  getConfigFiles() { return ['vite.config.mjs', 'vite.config.ts', 'vite.config.mjs', 'vite.config.cjs']; }
...
export class EsbuildPlugin extends BasePlugin {
  ...
  getConfigFiles() { return ['esbuild.config.mjs', 'esbuild.config.mjs', 'esbuild.config.ts']; }
...
export class RollupPlugin extends BasePlugin {
  ...
  getConfigFiles() { return ['rollup.config.mjs', 'rollup.config.mjs', 'rollup.config.ts']; }
...
export class WebpackPlugin extends BasePlugin {
  ...
  getConfigFiles() { return ['webpack.config.mjs', 'webpack.config.ts', 'webpack.config.mjs', 'webpack.config.cjs']; }
...
export class TailwindPlugin extends BasePlugin {
  ...
  getConfigFiles() { return ['tailwind.config.mjs', 'tailwind.config.ts', 'tailwind.config.mjs', 'tailwind.config.cjs']; }
...
export class PostcssPlugin extends BasePlugin {
  ...
  getConfigFiles() { return ['postcss.config.mjs', 'postcss.config.cjs', 'postcss.config.mjs', 'postcss.config.ts', '.postcssrc', '.postcssrc.json', '.postcssrc.mjs']; }
...
export class UnoCSSPlugin extends BasePlugin {
  ...
  getConfigFiles() { return ['uno.config.ts', 'uno.config.mjs', 'unocss.config.ts', 'unocss.config.mjs']; }
...
export class StylelintPlugin extends BasePlugin {
  ...
  getConfigFiles() { return ['.stylelintrc', '.stylelintrc.mjs', '.stylelintrc.cjs', '.stylelintrc.json', '.stylelintrc.yml', '.stylelintrc.yaml', 'stylelint.config.mjs', 'stylelint.config.cjs']; }
...
export class EslintPlugin extends BasePlugin {
  ...
  getConfigFiles() { return ['.eslintrc', '.eslintrc.mjs', '.eslintrc.cjs', '.eslintrc.json', '.eslintrc.yml', '.eslintrc.yaml', 'eslint.config.mjs', 'eslint.config.mjs', 'eslint.config.cjs']; }
...
export class PrettierPlugin extends BasePlugin {
  ...
  getConfigFiles() { return ['.prettierrc', '.prettierrc.mjs', '.prettierrc.cjs', '.prettierrc.json', '.prettierrc.yml', '.prettierrc.yaml', '.prettierrc.toml', 'prettier.config.mjs', 'prettier.config.cjs', 'prettier.config.mjs']; }
...
export class LintStagedPlugin extends BasePlugin {
  ...
  getConfigFiles() { return ['.lintstagedrc', '.lintstagedrc.mjs', '.lintstagedrc.cjs', '.lintstagedrc.json', '.lintstagedrc.yml', '.lintstagedrc.yaml', 'lint-staged.config.mjs', 'lint-staged.config.cjs']; }
...
export class CommitlintPlugin extends BasePlugin {
  ...
  getConfigFiles() { return ['.commitlintrc', '.commitlintrc.mjs', '.commitlintrc.cjs', '.commitlintrc.json', '.commitlintrc.yml', '.commitlintrc.yaml', 'commitlint.config.mjs', 'commitlint.config.cjs', 'commitlint.config.ts']; }
...
export class BabelPlugin extends BasePlugin {
  ...
  getConfigFiles() { return ['.babelrc', '.babelrc.mjs', '.babelrc.cjs', '.babelrc.json', '.babelrc.mjs', 'babel.config.mjs', 'babel.config.cjs', 'babel.config.json', 'babel.config.mjs']; }
...
export class JestPlugin extends BasePlugin {
  ...
  getConfigFiles() { return ['jest.config.mjs', 'jest.config.ts', 'jest.config.mjs', 'jest.config.cjs', 'jest.config.json']; }
...
export class VitestPlugin extends BasePlugin {
  ...
  getConfigFiles() { return ['vitest.config.mjs', 'vitest.config.ts', 'vitest.config.mjs', 'vitest.workspace.ts', 'vitest.workspace.mjs']; }
...
export class PlaywrightPlugin extends BasePlugin {
  ...
  getConfigFiles() { return ['playwright.config.ts', 'playwright.config.mjs']; }
...
export class CypressPlugin extends BasePlugin {
  ...
  getConfigFiles() { return ['cypress.config.ts', 'cypress.config.mjs', 'cypress.json']; }
...
export class StorybookPlugin extends BasePlugin {
  ...
  getConfigFiles() { return ['.storybook/main.mjs', '.storybook/main.ts', '.storybook/main.cjs', '.storybook/preview.mjs', '.storybook/preview.ts']; }
...
export class MswPlugin extends BasePlugin {
  get name() { return 'msw'; }
  getConfigFiles() { return ['msw.config.ts', 'msw.config.mjs', 'public/mockServiceWorker.mjs']; }
