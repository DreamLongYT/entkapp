...
export class NextJsPlugin extends BasePlugin {
  ...
  getConfigFiles() { return ['next.config.mjs', 'next.config.mjs', 'next.config.ts', 'next-env.d.ts']; }
...
export class VitePlugin extends BasePlugin {
  ...
  getConfigFiles() { return ['vite.config.mjs', 'vite.config.ts', 'vite.config.mjs', 'vite.config.cjs', 'vite-env.d.ts']; }
...
export class PostcssPlugin extends BasePlugin {
  ...
  getConfigFiles() { return ['postcss.config.mjs', 'postcss.config.cjs', 'postcss.config.mjs', 'postcss.config.ts', '.postcssrc']; }
...
export class UnoCSSPlugin extends BasePlugin {
  ...
  getConfigFiles() { return ['uno.config.ts', 'uno.config.mjs']; }
...
export class StylelintPlugin extends BasePlugin {
  ...
  getConfigFiles() { return ['.stylelintrc', 'stylelint.config.mjs']; }
...
export class EslintPlugin extends BasePlugin {
  ...
  getConfigFiles() { return ['.eslintrc', 'eslint.config.mjs']; }
...
export class PrettierPlugin extends BasePlugin {
  ...
  getConfigFiles() { return ['.prettierrc', 'prettier.config.mjs']; }
...
export class CommitlintPlugin extends BasePlugin {
  ...
  getConfigFiles() { return ['commitlint.config.mjs']; }
  getRequiredPackages() { return [{ name: '@commitlint/cli', dev: true }]; }
  async isActive(baseDir) {
    try { await fs.access(path.join(baseDir, 'commitlint.config.mjs')); return true; } catch { return false; }
  }
}
...
export class BabelPlugin extends BasePlugin {
  ...
  getConfigFiles() { return ['.babelrc', 'babel.config.mjs']; }
...
export class JestPlugin extends BasePlugin {
  ...
  getConfigFiles() { return ['jest.config.mjs']; }
  getRequiredPackages() { return [{ name: 'jest', dev: true }]; }
  async isActive(baseDir) {
    try { await fs.access(path.join(baseDir, 'jest.config.mjs')); return true; } catch { return false; }
  }
}

export class VitestPlugin extends BasePlugin {
  get name() { return 'vitest'; }
  getConfigFiles() { return ['vitest.config.ts', 'vitest.config.mjs']; }
...
export class StorybookPlugin extends BasePlugin {
  ...
  getConfigFiles() { return ['.storybook/main.mjs']; }
  getRequiredPackages() { return [{ name: 'storybook', dev: true }]; }
  async isActive(baseDir) {
    try { await fs.access(path.join(baseDir, '.storybook/main.mjs')); return true; } catch { return false; }
  }
}
...
export class RTLCSSPlugin extends BasePlugin {
  ...
  getConfigFiles() { return ['rtlcss.config.mjs']; }
  getRequiredPackages() { return [{ name: 'rtlcss', dev: true }]; }
  async isActive(baseDir) {
    try { await fs.access(path.join(baseDir, 'rtlcss.config.mjs')); return true; } catch { return false; }
  }
}
