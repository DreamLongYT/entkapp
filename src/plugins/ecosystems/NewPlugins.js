...
export class I18nextPlugin extends BasePlugin {
  ...
  getConfigFiles() { return ['i18next.config.js', 'i18next.config.ts', 'next-i18next.config.js']; }
...
export class SentryPlugin extends BasePlugin {
  ...
  getConfigFiles() { return ['sentry.client.config.ts', 'sentry.server.config.ts', 'sentry.edge.config.ts', 'sentry.config.js', 'sentry.config.ts']; }
