# Getting Started with pkg-scaffold v3.3.9

## Overview

pkg-scaffold v3.3.9 is a major update focused on solving the most critical issues currently facing the JavaScript/TypeScript ecosystem—many of which remain open in competing tools like Knip.
...
| Feature | pkg-scaffold v3.3.9 | Knip v6 Status |
| :--- | :--- | :--- |
...
> **Note**: Always use the `-r` or `--run` flag to execute the analysis loop. v3.3.9 focuses on security and precision.
