# Getting Started with entkapp v4.2.0

## Overview

entkapp v4.2.0 is a major update focused on solving the most critical issues currently facing the JavaScript/TypeScript ecosystem—many of which remain open in competing tools like Knip.
...
| Feature | entkapp v4.2.0 | Knip v6 Status |
| :--- | :--- | :--- |
...
> **Note**: Always use the `-r` or `--run` flag to execute the analysis loop. v4.2.0 focuses on security and precision.
